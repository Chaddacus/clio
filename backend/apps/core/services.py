    ...
    def transcribe_audio(self, audio_file, language='auto'):
        ...
        try:
            ...
            with open(temp_file_path, 'rb') as audio:
                ...
                logger.info("[WhisperTranscriptionService] Preparing OpenAI API call:")
                logger.info(f"  - Model: {self.model}")
                logger.info(f"  - Language: {language}")
                logger.info(f"  - Temperature: {self.temperature}")
                logger.info("  - Response format: verbose_json")
                ...
                try:
                    ...
                    logger.info("[WhisperTranscriptionService] OpenAI response details:")
            ...
            logger.info("[WhisperTranscriptionService] OpenAI API call successful, cleaning up temp file")
            if temp_file_path:
