...
from .serializers import (
    VoiceNoteListSerializer, VoiceNoteDetailSerializer, VoiceNoteCreateSerializer,
    TagSerializer, AudioTranscriptionSerializer
)
from apps.core.services import WhisperTranscriptionService, AudioProcessingService
...
class VoiceNoteListCreateView(generics.ListCreateAPIView):
    ...
    def _process_transcription(self, voice_note):
        ...
        try:
            ...
            logger.info(f"[_process_transcription] WhisperTranscriptionService initialized")
        except Exception as e:
        ...
        if duration:
            ...
            logger.warning(f"[_process_transcription] Could not determine audio duration")
